...
class NotificationPage {
  ...
  int deliver;
  init(BuildContext context, String title, String body, List<Commande> cmd,
      int livreur) {
    this.commandes = cmd;
    ...
    _scheduleNotification(context, title, body, cmd, livreur);
  ...
  Future _scheduleNotification(BuildContext context, String title, String body,
      List<Commande> cmd, int livreur) async {
    ...
    var bigTextStyleInformation = new BigTextStyleInformation(body,
        htmlFormatBigText: true,
        contentTitle: title,
        htmlFormatContentTitle: true,
        summaryText: '<b>Restaurant :</b> ' + cmd[0].restaurant.name,
    ...
    var iOSPlatformChannelSpecifics =
        new IOSNotificationDetails(sound: "slow_spring_board.aiff",presentSound: true);
    var platformChannelSpecifics = new NotificationDetails(
        androidPlatformChannelSpecifics, iOSPlatformChannelSpecifics);
    await flutterLocalNotificationsPlugin.schedule(
        0, title, body, scheduledNotificationDateTime, platformChannelSpecifics,
        payload: "nouvelle commande");
  ...
  Future onSelectNotification(String payload) async {
    ...
    showDialog(
      context: context,
      builder: (_) {
        return new NotificationScreen(this.commandes, this.deliver);
      },
    );
  }
  ...
  Future _showProgressNotification(String title, String body) async {
    var maxProgress = 30;
